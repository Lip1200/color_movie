...
def get_user_lists():
    ...
    lists_data = [{'list_id': lst.id, 'list_name': lst.nom_liste} for lst in lists]
...
def register_admin():
    ...
    existing_admin = Utilisateur.query.filter_by(is_admin=True).first()
    if existing_admin:
