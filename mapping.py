...
df_metrage.to_csv('metrage.csv', index=False)
...
df_serie.to_csv('serie.csv', index=False)
...
df_episode_export.to_csv('episode.csv', index=False)
...
df_people_export.to_csv('personne.csv', index=False)
...
df_distribution_personne.to_csv('distribution_personne.csv', index=False)
